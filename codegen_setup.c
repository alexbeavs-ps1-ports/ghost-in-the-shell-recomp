...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    ...
    .project_root_env = "GHOST_IN_THE_SHELL_PROJECT_ROOT",
    .build_dir_env = "GHOST_IN_THE_SHELL_BUILD_DIR",
    .force_setup_env = "GHOST_IN_THE_SHELL_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SCES_010.50_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Ghost_in_the_Shell_Recompiled",
    .prepare_note =
