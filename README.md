# Ghost in the Shell Recompiled

This release candidate uses PSXRecomp and the shared recomp-ui launcher.
You must supply your own SCES-01050 game disc and SCPH-5502/5552 Europe BIOS.
...
2. Start `Ghost_in_the_Shell_Recompiled` (`.exe` on Windows).
